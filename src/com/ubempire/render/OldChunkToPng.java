...
public class OldChunkToPng {
    ...
    OldChunkToPng(BananaMapRender plugin) {
        this.plugin = plugin;
                    ...
                    for (int x = 0; x < 16; x++)
                        for (int z = 0; z < 16; z++) {
                            ...
                            if (plugin.varDepthNormal()) {
                    			int y = region[cx][cz].getHighestBlockYAt(x, z)-1;
                    			int temp = region[cx][cz].getBlockEmittedLight(x, y, z);
                    			 ...
                    			 *
                    			 * Don't know what the hell this does
                    			 *
                    			...
                    			*/
                    			current = new Color(current.getRed()/2+y,current.getGreen()/2+y,current.getBlue()/2+y);
                    		}
